...
Pour finir, on peut conclure que la moyenne d'age 
...
#On tente de superposer les 2 courbes voir si il y a une corrélation :
combined_plot <- subplot(p2, p3, nrows = 2)
