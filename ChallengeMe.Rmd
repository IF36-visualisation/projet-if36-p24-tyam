...
shinyApp(ui, server)
```
Ainsi, pour pouvoir mieux visualiser ces données l, nous avons créé un shiny dashboard composé de deux pages, la première comptient le deuxième graphique mais avec une barre pourpouvoir choisir l'année souhaitée, on peut alors très facilement changer les années et comparer les graphes.
La deuxième page contient des boites contenant des stats, qui calculent à chaque fois la moyenne d'age de la ligue, la moyenne d'age des équipes qualifiées en playoffs et la moyenne d'age de celles qui ne sont pas qualifiées dans des boites différentes, et qui changent selon l'année.
